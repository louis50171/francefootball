...
<option value="angola">Mademoiselle</option>
				...
				<p>
				<label for="numabonnne" classe="numabonne" data-icon="T">Numero abonné</label> 
...
<p>				  
  ...
  S'abonner à la newsletter de Francefootball et recevoir les meilleurs informations 
